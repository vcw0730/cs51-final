...
def choose_option(g, start_end, locs, cities, e_file):
    """ User Interface """
    ...
    # run genetic
        ...
        children = int(raw_input("How many rounds to run genetic? Please enter a \
                                 number less than 2^25 to account for hardware \
                                 limitations. \n --> "))
        print "Running... "
        ...
        gen_result = tsp_genetic(children, g, start_end, cities, locs)

        # end timer
        t2 = round(time.time() - t1, 3)

        # record solution for run-time analysis
        e_file.write("Genetic time: " + str(t2) + " for " + str(get_cities)
    ...
    # print out current solutions
        ...
        y = int(raw_input("Which solution would you like to see? \n \
                         ...
                         2: genetic \n \
                         3: dynamic \n --> "))
        while ((y < 1 or y > 3) or (distance_set[y - 1] == [])):
            y = int(prompt("Sorry, either this algorithm doesn't exist or this \
